...
function M.parse(arg)
    ...
    cmd:option('-cropSize',          227,    'Height and Width of image crop to be used as input layer')
    ...
    cmd:option('-netType',     'alexnet_test', 'Options: alexnet | overfeat | alexnetowtbn | vgg | googlenet')
